...
//	public static String[] to ={"seleniumcoaching@gmail.com","trainer@way2automation.com"};
	public static String[] to ={"grakesh628@gmail.com"};
	...
	public static String mysqldriver="com.mysql.cj.jdbc.Driver";  // updated sqldriver as per error message.
	public static String mysqluserName = "root";
	public static String mysqlpassword = "6614";
	public static String mysqlurl = "jdbc:mysql://localhost:3306/referenceDB"; //referenceDB is database name.
